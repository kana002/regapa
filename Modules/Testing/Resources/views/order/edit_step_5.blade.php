    ...
    <div class="container px-5 pt-5 text-center">
        <div class="row pt-4">
            <div class="form-group col">
                <p class="text-center"><p class="text-center">{{ $empty_steps }}</p></p>
                <div class="d-flex justify-content-center align-items-center flex-column">
                    @foreach($steps_list as $st)
                        <p class="text-center bg-warning text-white col-4 rounded shadow p-2 fw-bold">{{ $st }}</p>
                    @endforeach
                </div>
            </div>
        </div>
...
@else
    <div class="container px-5 pt-5 text-center">
        <div class="row pt-4">
            <div class="form-group col">
                <p class="text-center"><p class="text-center">{{ __('modules.step_5_ready_order_msg') }}</p></p>
            </div>
        </div>
        <div class="row pt-4">
