...
class AdminUserController extends Controller
{
    ...
    public function index()
    {
        ...
        //dd($region);
        return view('admin::user.index',  compact('user','region', 'langs'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // dd($user);
        return redirect()->route('admin.all_users')->with('success','success');
    }
    ...
    public function edit($id)
    {
        ...
        //dd($reg_user);
        return view('admin::user.edit', compact('user', 'reg_user'))->with('success','success');
    }
