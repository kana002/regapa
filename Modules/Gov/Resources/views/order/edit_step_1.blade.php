...
<div class="container px-5 pt-5">
	<form action="{{route('gov.edit_order.update_step_1',  ['gen' => $order->gen])}}" method="post" enctype="multipart/form-data">
	@csrf
		<div class="row">
		...
		<div class="row py-4">
			<div class="form-group col-4">
                ...
                @if(isset($order) && $order->photo != null)
                    <p class="pt-2 m-0">
                    Ранее загружено: <a class="text-decoration-none" href="{{route('gov.download_order_photo', ['gen' => $order->gen])}}"
