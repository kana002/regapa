...
<div class="container px-5 pt-5">
	<form action="{{route('gov.new_order.store_step_1')}}" method="post" enctype="multipart/form-data">
	@csrf
		<div class="row">
		...
		<div class="row pt-4">
			...
			<div class="form-group col-4">
				...
				<input name="job_position" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Вашa должность"
				required>
			</div>
		</div>
		<div class="row py-4">
			...
			<div class="form-group col-4">
				...
				<select
					...
					@foreach($vaccines as $vac)
						<option value="{{$vac->id}}">{{$vac->name_ru}}</option>
					@endforeach
				</select>
			</div>
			<div class="form-group col-4">
