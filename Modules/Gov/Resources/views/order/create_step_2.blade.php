...
<div class="container px-5 pt-5">
	<form action="{{route('gov.new_order.store_step_2', ['gen' => request()->get('gen')])}}" method="post">
		@csrf
		<div class="row pt-4">
		...
		<div class="row pt-4">
			<div class="row" id="exps" style="display: none">
				...
				<div class="form-group col-6 pt-3" id="exp_1" style="display: none">
					...
					<textarea class="form-control" name="expectations" id="exampleFormControlTextarea1" rows="3" placeholder="" required></textarea>
				</div>
				<div class="form-group col-6 pt-3" id="exp_2" style="display: none">
					...
					<textarea class="form-control" name="expectations_2" id="exampleFormControlTextarea1" rows="3" placeholder="" required></textarea>
				</div>
