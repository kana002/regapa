            ...
            <div class=table>
                ...
                <table>
                    <tr>
                        ...
                        <td>Тыңдаушы басшысының байланыс деректері (жұмыс және ұялы, e-mail)</td>
                        <td>Кадр қызметінің байланыс деректері (жұмыс және ұялы, e-mail)</td>
                    </tr>
                    <tr>
                        ...
                        <td class=cont>ж. {{$order->student_boss_tel_job ?? ''}}
                            <br>м. {{$order->student_boss_tel_self ?? ''}}
                            <br>e. {{$order->student_boss_email ?? ''}}
                        </td>
                        <td class=cont>ж. {{$order->kadr_tel ?? ''}}
                            <br>м. {{$order->kadr_tel_mob ?? ''}}
                            <br>e. {{$order->kadr_email ?? ''}}
                        </td>
                    </tr>
                </table>
