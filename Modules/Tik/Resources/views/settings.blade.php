@extends('tik::layouts.master', ['settings' => 'active'])

@section('content')
<h2 class="text-center">Настройки аккаунта</h2>
<div class="container px-5 pt-5">
	<form action="{{route('tik.settings.store')}}" method="post">
	@csrf
        ...
        <div class="row mb-3 justify-content-center">
            <div class="form-group col-4">
                ...
                <input type="text" class="form-control" name="middlename" id="" placeholder="" value="{{$user->middlename}}" required >
            </div>
        </div>
        <div class="row mb-3 justify-content-center">
            <div class="form-group col-4">
